...
class _GetDataService implements GetDataService {
  ...
  Future<List<dynamic>?> getTopStories() async {
    ...
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<int> >(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<StoryModel> fetchSingleStory(id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<StoryModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
